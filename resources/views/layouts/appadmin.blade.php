                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="{{URL::to('ajoutertype')}}" class="dropdown-item">Ajouter type</a>
                                <a href="{{URL::to('ajoutreferentiel')}}" class="dropdown-item">Ajouter réferentiel</a>
                                <a href="{{URL::to('ajouterformation')}}" class="dropdown-item">Ajouter fomation</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="{{URL::to('types')}}" class="dropdown-item">Types</a>
                                <a href="{{URL::to('referentiels')}}" class="dropdown-item">Réferentiel</a>
                                <a href="{{URL::to('formations')}}" class="dropdown-item">Formations</a>
                            </div>
                        </div>
                    </div>
                </nav>
